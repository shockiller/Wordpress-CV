...
if( !empty( $atts['use_full_height_with_content_bottom'] ) && $atts['use_full_height_with_content_bottom'] == 'yes' )
	$css_classes[] = 'height-100vh';
...
if( $use_pattern_bg == 'yes' ) :
	...
	if( $pattern_styles == 'style_1' ) :
		...
		wp_enqueue_script('porfo-particle-style1');
		$output .= '<div id="particles-js"></div>';

	elseif( $pattern_styles == 'style_2' ) :

		wp_enqueue_script('porfo-particle-style2');
		$output .= '<div id="particles-js"></div>';

	elseif( $pattern_styles == 'style_3' ) :

		wp_enqueue_script('particles-package-3');
		wp_enqueue_script('porfo-particle-style3');
		$output .= '<canvas id="particles-js"></canvas>';

	elseif( $pattern_styles == 'style_4' ) :

		wp_enqueue_script('porfo-particle-style4');
		$output .= '<div id="particles-js"></div>';
